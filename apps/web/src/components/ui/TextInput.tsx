  ...
  return (
    <div className={cn("relative flex items-center", className)}>
      ...
      <input
        ...
        className={cn(
          "h-[30px] w-full appearance-none rounded-r border border-line bg-card pr-2.5 text-[12.5px] text-fg transition-[border-color,box-shadow] duration-[160ms] ease-bt focus:border-acc focus:shadow-[0_0_0_3px_var(--acc-soft)] pointer-coarse:h-11 [&::-webkit-search-cancel-button]:appearance-none",
          Icon ? "pl-[30px]" : "pl-2.5",
        )}
      />
    </div>
