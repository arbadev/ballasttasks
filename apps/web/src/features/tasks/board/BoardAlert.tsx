...
export function BoardAlert({ message, retryLabel, dismissLabel, onRetry, onDismiss, onFocus, onBlur }: BoardAlertProps) {
  return (
    <div role="alert" onFocusCapture={onFocus} onBlurCapture={onBlur} className="mx-8 mt-4 flex animate-bt-in items-center gap-3 rounded-bt border border-line bg-danger-soft py-2 pr-2 pl-3.5 text-[12.5px] text-fg max-md:mx-4">
