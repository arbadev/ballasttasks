...
- `filters.visual.ts` checks the complete control's focus-ring geometry at 1440px and 375px,
  immediately under normal and reduced motion. It drives pointer focus, Tab, native type-ahead
  and Enter, plus `selectOption` for the application-level change contract, and asserts values,
