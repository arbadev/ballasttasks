...
The database URL comes from the application ``Settings`` (``DATABASE__URL``): settings.py
stays the only place that reads the environment, and ``alembic.ini`` holds no URL.
"""
